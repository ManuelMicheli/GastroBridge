// components/dashboard/supplier/_awwwards/quick-action-bar.tsx
//
// Supplier-scoped variant of the restaurant QuickActionBar.
// Same terminal pill-bar treatment, supplier-area hrefs.
...
const PILLS: Pill[] = [
  { href: "/supplier/catalogo/nuovo", label: "Nuovo prodotto" },
  { href: "/supplier/ordini", label: "Ordini" },
  { href: "/supplier/clienti", label: "Clienti" },
  { href: "/supplier/listini", label: "Listini" },
  { href: "/supplier/messaggi", label: "Messaggi" },
];

export function SupplierQuickActionBar() {
  return (
    <nav
