...
export function TypicalOrderAdd({
  ...
  return (
    <div className="relative">
      <div className="flex flex-wrap items-center gap-2 rounded-lg border border-border-subtle bg-surface-card px-3 py-2 focus-within:ring-2 focus-within:ring-accent-green/40 md:flex-nowrap">
        <div className="flex w-full min-w-0 flex-1 items-center gap-2 md:w-auto">
        ...
        <div className="flex w-full items-center gap-2 md:w-auto">
          ...
          <input
            ...
            className="w-20 shrink-0 rounded border border-border-subtle bg-surface-base px-2 py-1.5 text-right font-mono tabular-nums text-text-primary md:w-16 md:py-1"
          />
          <button
            onClick={() => commit(undefined)}
            disabled={suggestions.length === 0}
            className="inline-flex flex-1 shrink-0 items-center justify-center gap-1 rounded-lg bg-accent-green px-3 py-2 text-[13px] font-medium text-surface-base disabled:opacity-40 md:flex-none md:py-1.5"
          >
